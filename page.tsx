...
import PayPalStarterButton from "../components/PayPalStarterButton"
import PayPalAdvancedButton from "../components/PayPalAdvancedButton"
import PayPalProButton from "../components/PayPalProButton"
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-12">
              ...
              <div className="md:w-3/5">
                <div className="bg-white/50 backdrop-blur-sm rounded-lg p-6 shadow-lg border border-[#1a4b84]/10">
                  <p className="text-lg mb-4 text-gray-700">
                    Als leidenschaftliche Radsportlerin mit nationaler und internationaler Wettkampferfahrung bringe ich
                    eine einzigartige Perspektive ins Coaching ein. Mein Hintergrund umfasst Arbeit mit Athletinnen im
                    Rad- und Laufsport und ein tiefes Verständnis für die spezifischen Herausforderungen und Chancen,
                    denen sie im Sport begegnen.
                  </p>
                  <p className="text-lg mb-4 text-gray-700">
