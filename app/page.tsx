      ...
      <main className="relative z-10">
        ...
        <section className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
          <div className="container mx-auto text-center">
            ...
            <Link
              href="/preise"
              className="bg-white text-[#191340] py-3 sm:py-4 px-6 sm:px-8 rounded-full font-semibold hover:bg-gray-100 transition duration-300 inline-block shadow-lg text-base sm:text-lg min-h-[44px] flex items-center justify-center"
            >
              Jetzt starten
            </Link>
          </div>
